...
const CollectionsPage = () => {
    ...
    const [collectionToView, setCollectionToView] = useState<CollectionModel | null>(null);
            ...
            {collections.map(collection => (
                <Col key={collection._id}>
                    <Collection
                        ...
                        onCollectionClicked={setCollectionToView}/>
                </Col>
            ))}
        </Row>
        ...
        <>
            ...
            {collectionToView &&
                <CollectionDialog
                    ...
                    onDismiss={() => setCollectionToView(null)}
                />
            }
        </>
    );
